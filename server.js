...
var uID = '76561197960435530';

var victorID = '76561198081319463';

var profile = 'http://api.steampowered.com/ISteamUser/GetPlayerSummaries/' +
'v0002/?key=YOURSTEAMAPIKEYHERE&steamids=' + victorID;

app.get('/steam/GetPlayerSummaries', function(httpRequest, httpResponse) {
  var uID = '76561197960435530';
  var victorID = '76561198081319463';
  ...
  request.get(profile, function(error, steamHttpResponse, steamHttpBody) {
